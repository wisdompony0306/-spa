...
export default (container, options) => {
    ...
    let offloadFn = function(fn, delay) {
 setTimeout(fn || noop, delay || 0);
    ...
    function setup() {
        ...
        offloadFn(options.callback && options.callback(index, slides[index], length));
    }
    ...
    var events = {
        ...
        handleEvent: function(event) {
            switch (event.type) {
                ...
                case 'resize': offloadFn(setup, 400); break;
            }
        ...
        move: function(event) {
            ...
            if (!isScrolling) {
                if (isValidSlide && !isPastBounds) {
                    ...
                    options.callback && options.callback(index, slides[index], length);
                } else {
                    if (options.continuous) {
